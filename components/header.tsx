                    ...
                    <div className={"flex items-center space-x-2 lg:space-x-5"}>
                        ...
                        <nav className={"hidden items-center space-x-2 lg:flex"}>
                            ...
                            {/* Home Button */
                                <Link
                                    href={"/"}
                                    className={`group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium ${pathname === "/" ? "text-blue-600" : ""} hover:text-blue-600 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600`}
                                >
                                    <svg
                            ...
                            {/* Soalam Lazim */}
                                <Link
                                href={"/soalanlazim"}
                             className={`group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium ${pathname === "/soalanlazim" ? "text-blue-600" : ""} hover:text-blue-600 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600`}>
                            <svg
                        ...
                        <Link
                            ...
                            className={`group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium ${pathname === "/soalanlazim" ? "text-blue-600" : ""} hover:text-blue-600 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600`}>
                            <svg
                                className={"hi-mini hi-code inline-block size-5 opacity-25 group-hover:opacity-100"}
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                aria-hidden="true"
                        ...
                        <Link
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 className={"hi-mini hi-bold inline-block size-5 opacity-25 group-hover:opacity-100"}
                            >
                                <path fillRule="evenodd"
            ...
            <div className={`lg:hidden ${mobileNavOpen ? "" : "hidden"}`}>
                <nav className={"flex flex-col space-y-2 border-t py-4 dark:border-gray-700"}>
                    ...
                    <a
                        ...
                        className={"group flex items-center space-x-2 rounded-lg border border-transparent px-3 py-2 text-sm font-medium text-gray-800 hover:bg-blue-50 hover:text-blue-600 active:border-blue-100 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:active:border-gray-600"}
                    >
                        <svg className={"hi-mini hi-code inline-block size-5 opacity-25 group-hover:opacity-100"}
                             xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 24 24"
                             fill="currentColor"
                             aria-hidden="true"
