    ...
    if (user) {
        return (
            <button
                ...
                className={`group flex items-center space-x-2 rounded-xl border border-transparent px-3 py-2 text-sm  font-medium hover:bg-blue-50 ${pathname === "/merchant/signup" ? "text-blue-600 bg-blue-50  font-semibold" : "text-white"} hover:text-blue-600 active:border-blue-100 `}
            >
                <svg xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 24 24" fill="currentColor"
                     className={`hi-mini hi-bold inline-block size-5  ${pathname === "/merchant/signup" ? 'opacity-100' : 'opacity-80'} group-hover:opacity-100 `}
                >
