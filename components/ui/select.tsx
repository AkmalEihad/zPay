...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center bg-gray-50 dark:bg-zinc-800 justify-between whitespace-nowrap rounded-md border border-neutral-200  px-3 py-2 text-sm shadow-sm ring-offset-neutral-400 placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:ring-offset-neutral-400 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-400 ",
      className
    )}
    {...props}
  >
